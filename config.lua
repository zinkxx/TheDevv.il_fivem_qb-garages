...
Garages = {
    ...
    ['larissa'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-1178.24, -1131.62),
                vector2(-1180.75, -1124.56),
                vector2(-1185.84, -1126.25),
                vector2(-1183.26, -1133.26)
            },
            ['minZ'] = 1.00,  -- min height of the parking zone
            ['maxZ'] = 10.89,  -- max height of the parking zone
        },
        label = "Larissa Parking",
        showBlip = true,
        blipcoords = vector3(-1181.31, -1129.92, 5.7),
        blipName = "Garaj",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-1182.14, -1129.72, 5.7, 35.05),
        }
    },
    ['airportp'] = {
        ['Zone'] = {
    ...
    ['sheriff'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(394.03, -1631.74),
            vector2(399.82, -1624.17),
            vector2(405.5, -1616.9),
            vector2(399.15, -1611.51),
            vector2(392.07, -1605.45),
            vector2(385.52, -1612.44),
            vector2(379.74, -1619.77)
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(388.09, -1611.84, 29.29, 243.97),
            vector4(390.06, -1610.14, 29.29, 275.12),
            vector4(392.49, -1607.9, 29.29, 204.32),
            vector4(402.96, -1616.65, 29.29, 7.65),
            vector4(401.39, -1619.33, 29.29, 105.44),
            vector4(398.99, -1621.4, 29.29, 111.0),
            vector4(397.46, -1623.89, 29.29, 79.87),
            vector4(395.25, -1626.47, 29.29, 81.48)
        }
    },
    ['mechanic'] = {
        ['Zone'] = {
    ...
    ['mechanic1'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-35.84, -1026.83),
            vector2(-26.87, -1030.41),
            vector2(-18.2, -1033.56),
            vector2(-14.92, -1027.8),
            vector2(-22.71, -1024.74),
            vector2(-33.75, -1021.0),
            },
            ['minZ'] = 27.90,  -- min height of the parking zone
            ['maxZ'] = 30.0,  -- max height of the parking zone
        },
        label = 'Bennys Mekanik 1',
        type = 'public',
        showBlip = true,
        blipcoords = vector3(-32.83, -1024.09, 28.82),
        blipName = "Garaj",
        blipNumber = 357,
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-32.83, -1024.09, 28.82, 339.82),
            vector4(-29.77, -1025.21, 28.85, 341.37),
            vector4(-26.76, -1026.66, 28.88, 336.74),
            vector4(-23.84, -1027.88, 28.9, 341.81),
            vector4(-20.98, -1029.3, 28.93, 341.11),
            vector4(-17.93, -1030.0, 28.94, 332.59),
        },
        debug = false
    },
    ...
    ['mechanic3'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(701.0, -1116.79),
            vector2(707.09, -1101.3),
            vector2(699.77, -1098.76),
            vector2(693.97, -1114.21),
            },
            ['minZ'] = 21.44,  -- min height of the parking zone
            ['maxZ'] = 24.0,  -- max height of the parking zone
        },
        label = 'Los Santos Customs (Köprü)',
        type = 'public',
        showBlip = true,
        blipcoords = vector3(702.91, -1102.06, 22.44),
        blipName = "Garaj",
        blipNumber = 357,
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(702.91, -1102.06, 22.44, 63.74),
            vector4(700.75, -1107.3, 22.47, 66.02),
            vector4(698.59, -1113.51, 22.53, 72.29),
        },
        debug = false
    },
    ...
    ['mechanic4'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(159.05, -3011.47),
            vector2(159.06, -3000.6),
            vector2(159.08, -2998.28),
            vector2(159.21, -2987.62),
            vector2(167.66, -2987.63),
            vector2(167.87, -3011.54),
            },
            ['minZ'] = 5.0,  -- min height of the parking zone
            ['maxZ'] = 7.0,  -- max height of the parking zone
        },
        label = 'Mekanik (Liman)',
        type = 'public',
        showBlip = true,
        blipcoords = vector3(162.18, -3009.37, 5.96),
        blipName = "Garaj",
        blipNumber = 357,
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(162.18, -3009.37, 5.96, 264.41),
            vector4(162.31, -3006.03, 5.95, 269.74),
            vector4(162.3, -3002.82, 5.95, 268.32),
            vector4(163.54, -2999.53, 5.93, 268.38),
            vector4(162.72, -2996.4, 5.94, 271.41),
            vector4(162.62, -2993.05, 5.94, 271.89),
            vector4(162.75, -2989.88, 5.92, 269.32),
        },
        debug = false
    },
    ...
    ['iskele'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-1824.65, -1252.95),
            vector2(-1813.94, -1241.64),
            vector2(-1810.24, -1244.62),
            vector2(-1820.54, -1256.9),
            vector2(-1823.77, -1260.33),
            vector2(-1827.85, -1256.72),
            },
        ...
        type = 'public',
        showBlip = true,
        blipcoords = vector3(-1813.84, -1244.37, 13.02),
        blipName = "Garaj",
        blipNumber = 357,
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-1813.84, -1244.37, 13.02, 51.78),
            vector4(-1816.15, -1246.94, 13.02, 48.43),
            vector4(-1818.41, -1249.51, 13.02, 46.54),
            vector4(-1821.32, -1252.7, 13.02, 50.26),
            vector4(-1823.46, -1255.89, 13.02, 44.31),
        },
        debug = false
    },
    ...
    ['mechanicgabzisk'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-1371.93, -449.5),
            vector2(-1374.4, -445.06),
            vector2(-1384.07, -452.36),
            vector2(-1381.74, -456.17),
            },
            ['minZ'] = 33.0,  -- min height of the parking zone
            ['maxZ'] = 37.0,  -- max height of the parking zone
        },
        label = 'mechanicgabzisk',
        type = 'public',
        showBlip = true,
        blipcoords = vector3(-1381.56, -452.6, 34.48),
        blipName = "Garaj",
        blipNumber = 357,
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ["ParkingSpots"] = {
            vector4(-1381.56, -452.6, 34.48, 208.54),
            vector4(-1379.0, -451.14, 34.48, 209.2),
            vector4(-1376.7, -449.6, 34.48, 210.25),
            vector4(-1374.53, -448.3, 34.48, 217.64),
        },
        debug = false
    },
